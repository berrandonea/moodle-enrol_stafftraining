 ...
 * Self unenrolment from a course/training.
 */
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'stafftraining'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/stafftraining/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_stafftraining', format_string($course->fullname));
