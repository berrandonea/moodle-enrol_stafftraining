...
$capabilities = array(
    ...
    /* Add or edit enrol-stafftraining instance in course. */
    'enrol/stafftraining:config' => array(
    ...
    /* Manage user stafftraining-enrolments. */
    'enrol/stafftraining:manage' => array(
    ...
    'enrol/stafftraining:holdkey' => array(
    ...
    'enrol/stafftraining:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'enrol/stafftraining:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
